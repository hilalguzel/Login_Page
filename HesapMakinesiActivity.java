...
public class HesapMakinesiActivity extends AppCompatActivity {
    Button b1, b2, b3, b4, b5, b6, b7, b8, b9, b0, bdot, bpi, bequal, bmin, bplus, bdiv, bmul,
            bminus, blog, bac, bc, bb1, bb2, bln, bsin, bcos, btan, binv, bsqrt, bsquare, bfact;
    ...
    public static double eval(final String str) {
        return new Object() {
            ...
            double parseTerm() {
                ...
                for (; ; ) {
                    if (eat('*')) x *= parseTerm(); //Carpma
                    else if (eat('/')) x /= parseTerm(); //Bolme
                    else return x;
                }
            }
